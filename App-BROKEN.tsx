...
const INITIAL_EVENT_PROFILE: EventProfile = {
  ...
  edition: '10ª Edição 2024',
  eventType: 'Festival Híbrido',
  organizer: 'Produtora Lumina',
  sponsors: 'Patrocinadores: Orbit Media • SoundWave • Cerveja Solar',
  cnpj: '45.987.321/0001-12',
  licensingStatus: 'Licenças confirmadas',
  logoUrl:
    'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80',
  themeColor: '#d946ef',
  socialLinks: {
    instagram: 'auroralive',
    website: 'www.auroralive.com',
  },
};
...
const INITIAL_FINANCIALS: FinancialKPI = {
  ...
  spentToday: 3240,
  balance: 145000,
  spendingLimit: 600000, // teto programado para produção
  totalSpent: 355000
};

const INITIAL_EXPENSES: ExpenseCategory[] = [
  { name: 'Produção Técnica', value: 150000, color: '#3b82f6' },
  { name: 'Infraestrutura', value: 80000, color: '#f59e0b' },
  { name: 'Experiência', value: 45000, color: '#10b981' },
  { name: 'Marketing', value: 80000, color: '#8b5cf6' },
];

const INITIAL_LOCATIONS: CampaignLocation[] = [
  { id: '1', name: 'Arena Central', status: LocationStatus.HighInvestment, coordinates: { x: 30, y: 40 } },
  { id: '2', name: 'Auditório Conexões', status: LocationStatus.MediumInvestment, coordinates: { x: 60, y: 30 } },
  { id: '3', name: 'Espaço Lounge', status: LocationStatus.LowInvestment, coordinates: { x: 50, y: 60 } },
];
...
const INITIAL_INVENTORY: InventoryItem[] = [
  { id: '1', name: 'Kits VIP', location: 'Arena Central', quantity: 150, status: 'low', type: 'material' },
  { id: '2', name: 'Pulseiras Acesso', location: 'Backstage', quantity: 5000, status: 'ok', type: 'material' },
  { id: '3', name: 'Painéis LED', location: 'Depósito', quantity: 12, status: 'ok', type: 'material' },
  { id: '4', name: 'Diesel Reservado', location: 'Base Operacional', quantity: 200, status: 'ok', type: 'fuel' },
  { id: '5', name: 'Catering Equipe', location: 'Copa Produção', quantity: 20, status: 'low', type: 'food' },
];

const INITIAL_TASKS: Task[] = [
  {
    id: '101',
    title: 'Design convite VIP',
    description: 'Criar arte para enviar aos parceiros confirmados.',
    status: 'creation',
    assignee: 'Designer',
  },
  {
    id: '102',
    title: 'Vídeo teaser headline',
    description: 'Finalizar edição com cenas do palco e depoimentos.',
    status: 'briefing',
    assignee: 'Editor',
  },
  {
    id: '103',
    title: 'Impulsionamento mídias sociais',
    description: 'Segmentação para público 25-40 interessados em música eletrônica.',
    status: 'done',
    cost: 500.0,
    assignee: 'Growth',
  },
...
const INITIAL_EVENTS: CalendarEvent[] = [
  {
    ...
    logistics: {
      ...
      fuelEstimatedLiters: 12,
      materials: ['Checklist de áudio'],
      permitsChecked: true,
    },
  },
  {
    id: 'e2',
    title: 'Painel Futuro da Música',
    date: new Date(Date.now() + 86400000).toISOString().split('T')[0],
    location: 'Auditório Conexões',
    type: 'painel',
    status: 'pending',
    weather: 'rain',
    logistics: {
      vehicles: ['Van Convidados', 'Sprinter Técnica'],
      staffCount: 20,
      dietaryRestrictions: false,
      fuelEstimatedLiters: 25,
      materials: ['Credenciais painelistas'],
...
const INITIAL_TRANSACTIONS: Transaction[] = [
  {
    id: 't1',
    description: 'Impulsionamento campanha digital',
    category: 'Marketing',
    amount: 500,
    date: 'Hoje',
  ...
  {
    id: 't2',
    description: 'Abastecimento Sprinter Técnica (OCR)',
    category: 'Logística',
    amount: 350,
    date: 'Hoje',
    source: 'ocr',
    assetLinked: 'Sprinter Técnica XPT-2024',
  },
];
...
const INITIAL_TEAM: TeamMember[] = [
  {
    ...
    phone: '11 98888-0001',
    email: 'ana@auroralive.com',
    status: 'active',
    photoUrl: 'https://i.pravatar.cc/150?u=ana_producao',
  },
  {
    id: '2',
    name: 'Carlos Souza',
    ...
    phone: '11 97777-0002',
    email: 'carlos@auroralive.com',
    status: 'busy',
    photoUrl: 'https://i.pravatar.cc/150?u=carlos_log',
  },
  {
    id: '3',
    name: 'Fernanda Rocha',
    role: 'Compliance & Licenças',
    phone: '11 96666-0003',
    email: 'fernanda@auroralive.com',
    status: 'offline',
    photoUrl: 'https://i.pravatar.cc/150?u=fernanda_compliance',
  },
];
  
const INITIAL_VEHICLES: Vehicle[] = [
  { id: 'v1', name: 'Sprinter Técnica', plate: 'XPT-2024', type: 'van', currentKm: 45000, status: 'active' },
  { id: 'v2', name: 'Truck PA', plate: 'PAW-9088', type: 'truck', currentKm: 12000, status: 'active' },
  { id: 'v3', name: 'SUV Produção', plate: 'HZN-4455', type: 'car', currentKm: 8500, status: 'active' },
];
...
const INITIAL_FUEL_LOGS: FuelLog[] = [
  {
    ...
    cost: 290.0,
    kmAtRefuel: 44800,
    stationName: 'Base Combustível Aurora',
  },
];
...
const INITIAL_CANVAS_SPACES: CanvasSpace[] = [
  {
    id: 'space-main-stage',
    name: 'Main Stage Ops',
    description: 'Layout técnico do palco principal, front of house e zonas de público.',
    origin: { x: 0, y: 0 },
    scale: 1,
    templates: ['Stage Plot', 'Crisis Response'],
    nodes: [
      {
        id: 'frame-main-stage',
        type: 'frame',
        ...
        height: 420,
        color: '#38bdf8',
        metadata: { dimensions: '80m x 50m', capacity: '15.000 pax' },
      },
      {
        id: 'sticky-pa',
        type: 'sticky',
